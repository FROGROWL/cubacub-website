...
MIDDLEWARE = [
    ...
    "api.other.middleware.ActivityMiddleware",
    "api.other.middleware.InactivityMiddleware",
]
...
AUTH_USER_MODEL = "api.StaffAccount"
CORS_ALLOW_ALL_ORIGINS = env.bool("CORS_ALLOW_ALL_ORIGINS", default=DEBUG)
CORS_ALLOWED_ORIGINS = [] if CORS_ALLOW_ALL_ORIGINS else env.list("CORS_ALLOWED_ORIGINS", default=[])
